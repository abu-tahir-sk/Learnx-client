  ...
  return (
    <div className="h-screen flex flex-col justify-center items-center">
      <div className="max-w-7xl mx-auto px-20 py-8  lg:flex flex-col justify-end items-end   ">
        ...
        <div className="py-8 px-10 w-full text-white bg-[#141e2b] block lg:hidden rounded">
            ...
            <div className=" flex flex-col justify-center items-center ">
              <form>
               <label className="w-full relative ">
                ...
                />
              <span className="absolute text-xl text-gray-400 left-6 top-[1px] "> <TfiEmail  /></span>
               </label>
               <label className="w-full relative ">
                <input
                  type="password"
                ...
                />
                  <span className="absolute text-xl text-gray-400 left-6 top-[1px] "> <IoKeyOutline /></span>
              </label>
        ...
        {/* lg screen form  */}
          <div className=" p-10 text-white bg-[#141e2b] shadow-2xl hidden md:block  absolute top-10 bottom-4 -left-[50%] rounded w-[70%] h-[80vh]">
            <h3 className="text-3xl font-bold text-center pb-10">
              Login please
            </h3>
