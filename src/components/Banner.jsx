...
const Banner = () => {
  return (
    <div className="w-full lg:max-w-7xl xl:max-w-6xl mx-auto px-4 py-10 dark:text-white">
      {data.map((banner) => (
        <div
          key={banner.id}
        ...
        {/* left content  */}
          <div className="w-full md:w-1/2 space-y-6 text-center md:text-start">
            ...
            <p className="text-[16px] sm:text-lg md:text-xl leading-relaxed text-gray-600" inter>
              {banner.description}
            </p>
